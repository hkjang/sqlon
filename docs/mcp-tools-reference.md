...
| ④ DB 플릿·관찰 | `list_db_profiles`, `list_database_instances`, `get_fleet_health`, `list_sessions`, `get_lock_tree`, `get_replication_status`, `get_workload_summary`, `get_top_sql`, `get_storage_status`, `route_db_profile` |
