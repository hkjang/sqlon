...
레퍼런스(90종), SQL 생성 워크플로, 검증 룰 카탈로그(33종), 데이터셋
...
| 표준 컨테이너 | `docker build -t sqlon/sqlon:v0.58.0 .` |
...
```sh
docker build -t sqlon/sqlon:v0.58.0 .
docker build -f Dockerfile.oracle -t sqlon/sqlon-oracle:v0.58.0 .
