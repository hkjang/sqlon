...
(function () {
  ...
  var GUIDES = {
    ...
    settings: '## 서버 설정 (관리자)\n\n마스터 토큰·허용 Origin·Keycloak SSO·방문 추적을 메타 DB에 저장하고 즉시 적용합니다.\n\n### 방문 추적\n기본은 꺼짐입니다. 제공자는 사내 수집기 **momento** 를 먼저 두며, 같은 오리진 프록시(`/momento/*`)를 쓰면 외부 출처가 정책(CSP)에 등장하지 않습니다. 스니펫은 요청마다 nonce 를 달고 나가고, 정책에 막힌 출처는 아래 표에서 한 번에 허용할 수 있습니다.',
  };
